...
export default function ConfirmPasswordForm() {
    ...
    const budetId = +searchParams.get('deleteBudgetId')!

    const deleteBudgetWithPasword = deleteBudget.bind(null, budetId)

    const [state, dispatch] = useFormState(deleteBudgetWithPasword, {
        errors: [],
        success: ''
    })
